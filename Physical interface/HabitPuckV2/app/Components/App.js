...
import EffortScreen from "./Effort";
...
export default function App() {
    ...
    //This is just for showing a streak. It is just the current day of the week
    const [streak, setStreak] = useState({ streak: ((new Date().getDay() + 6) % 7) + 1, omissions: 0 });
    ...
    useEffect(() => {
        setHistoryCounts(History.getMockHistory);
